    ...
    return (
      <div className="main-content">
        ...
        <div className="pagination">
          {page !== 1 && <button className="boton-paginacion" onClick={() => setPage(page - 1)}>Anterior</button>}
          <button className="boton-paginacion" onClick={() => setPage(page + 1)}>Siguiente</button>
        </div>
      </div>
    );
